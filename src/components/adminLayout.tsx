...
export function AdminLayout({ children, currentPage }: AdminLayoutProps) {
  ...
  const allNavItems = [
    { id: "dashboard", label: "Dashboard", icon: Gauge, href: routes.admin },
    { id: "turnos", label: "Gestión de Turnos", icon: Calendar, href: routes.dashboard_turnos },
    { id: "odontologos", label: "Gestión de Doctores", icon: BriefcaseMedical, href: routes.dashboard_odontologos },
    { id: "pacientes", label: "Gestión de Pacientes", icon: Users, href: routes.dashboard_pacientes },
    { id: "historia-clinica", label: "Historia Clínica", icon: ClipboardPlus, href: routes.dashboard_historia_clinica },
    { id: "servicios", label: "Gestión de Servicios", icon: Pill, href: routes.dashboard_servicios },
    { id: "usuarios", label: "Gestión de Usuarios", icon: Settings, href: routes.dashboard_users },
    { id: "perfil", label: "Mi Perfil", icon: User, href: routes.dashboard_profile },
  ];
          ...
          <div className="flex items-center gap-3">
            {sidebarOpen ? (
              <div className="flex-1 min-w-0">
                <p className="font-bold text-slate-800 truncate">{uData?.fullname || uData?.username || "Usuario"}</p>
              ...
              <div className="w-full flex justify-center">
                <div className="w-2 h-2 rounded-full bg-purple-400" title={`Conectado como Administrador`}></div>
              </div>
            )}
          </div>
        </div>
        ...
        <header className="bg-white/80 backdrop-blur-md border-b border-teal-100 shadow-sm sticky top-0 z-30">
          <div className="px-4 md:px-8 py-4 flex items-center justify-between">
            ...
            <div className="flex items-center gap-3 overflow-hidden mr-4">
              ...
              <h1 className="text-lg md:text-xl font-bold text-slate-900 truncate hidden sm:block">
